...
class Sequence_builder(Window_ui, Sequence_parser):
    ...
    # def displaytext_scan_T(data):
    #     """generate the displaytext for the temperature scan"""
    # return 'Scan Temperature from {start} to {end} in {Nsteps} steps,
    # {SweepRate}K/min, {ApproachMode}, {SpacingCode}'.format(**data)

    # @staticmethod
    # def displaytext_scan_H(data):
    #     """generate the displaytext for the field scan"""
    # return 'Scan Field from {start} to {end} in {Nsteps} steps,
    # {SweepRate}K/min, {ApproachMode}, {SpacingCode},
    # {EndMode}'.format(**data)

    # @staticmethod
    # def displaytext_set_temp(data):
    #     """generate the displaytext for a set temperature"""
    # return 'Set Temperature to {Temp} at {SweepRate}K/min (rate is only a
    # wish...)'.format(**data)
    ...
    # def displaytext_set_field(data):
    #     """generate the displaytext for a set field"""
    # return 'Set Field to {Field} at {SweepRate}T/min (rate is only a
    # wish...)'.format(**data)
